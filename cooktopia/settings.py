"""
Django settings for cooktopia project.
...
WSGI_APPLICATION = 'cooktopia.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_ACCESS_KEY_ID = os.envoiron.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY_ID = os.envoiron.get('AWS_SECRET_ACCESS_KEY_ID')
